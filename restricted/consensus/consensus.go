...
type Engine interface {
	...
	Finalize(chain ChainHeaderReader, header *types.Header, state core.RWStateDB, body *types.Body)
	...
	FinalizeAndAssemble(chain ChainHeaderReader, header *types.Header, state core.RWStateDB, body *types.Body, receipts []*types.Receipt) (*types.Block, error)
